...
**A clean and elegant AI chat interface built with Svelte 5 + TypeScript, featuring multi-model configs, streaming responses, and visible reasoning—ready to use and easy to extend**
